...
// Nota: ahr_1, ahr_2 y ahr_3 (Opportunity Solution Tree, Product Outcome,
// Användarsegment) ya se muestran en el carrusel de /grafiskproduktion/1,
// así que aquí solo se incluyen las 4 imágenes exclusivas de Hi-Fi prototyp.
const IMGS = [ahr4Img, ahr5Img, ahr6Img, ahr7Img];
