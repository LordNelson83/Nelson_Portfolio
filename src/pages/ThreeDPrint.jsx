...
export default function ThreeDPrint() {
  ...
  return (
    <div className="td-page">
      ...
      <div className="td-bg-image" style={{ backgroundImage: `url(${bgPrint})` }} aria-hidden="true" />
      ...
      <section className="td-cta">
        ...
        <Link to="/kontakta" className="td-cta__btn">{td.ctaBtn}</Link>
      </section>
    </div>
  );
}
